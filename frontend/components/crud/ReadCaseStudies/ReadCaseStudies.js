...
import { list, removeCaseStudy } from "../../../actions/caseStudy";

const ReadCaseStudies = ({ username }) => {
    ...
    const deleteBlog = async (slug) => {
      let blog;
      try {
        blog = await removeCaseStudy(slug, token);
      ...
      <>
        <div className="read-blogs">
          <div className="read-blogs__banner">
            <h4 className="read-blogs__title">Manage Case Studies</h4>
          </div>

...
import { getTags } from "../../../actions/funding-tags";
import { createBlog } from "../../../actions/fund-raising-blogs";
...
const CreateFundRaisingBlog = ({ router }) => {
      ...
      <div className="create-blog__wrapper">
        <form onSubmit={publishBlog}>
          ...
          <div className="form-group">
            <ReactQuill
              modules={CreateFundRaisingBlog.modules}
              formats={CreateFundRaisingBlog.formats}
              bounds={".quill"}
              value={body}
...
export default withRouter(CreateFundRaisingBlog);
